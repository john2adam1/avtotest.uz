        ...
        <div className="container mx-auto px-6 py-24 md:py-32 relative text-center">
            <div className="max-w-4xl mx-auto space-y-10 relative z-10">
                <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white border border-blue-100 text-blue-600 text-xs font-black uppercase tracking-widest shadow-xl shadow-blue-500/5">
                    ...
                    <span suppressHydrationWarning>{t("landing.badge")}</span>
                </div>

                <h1 suppressHydrationWarning className="text-4xl md:text-6xl lg:text-8xl font-black text-slate-900 leading-[1.1] tracking-tighter italic uppercase">
                    {t("hero_title")}
                </h1>

                <p suppressHydrationWarning className="text-xl md:text-2xl text-slate-500 mb-8 max-w-2xl mx-auto leading-relaxed font-bold">
                    {t("hero_subtitle")}
                </p>
